...
{social_contract}
This previous guess was {current_gain}%s satisfactory.
---------------------------
...
Finally, is this principle instructing the players to be altruistic, to be selfish, or to be fair? Answer in one word: “Altruistic.”, “Selfish.”, or “Fair.” (There are no other options. Be sure to choose one of these three options.)
"""
